...
import { Search, Star, MapPin, Filter, X, MessageCircle, Briefcase, Clock, DollarSign, Users, ExternalLink, Github, Linkedin, Link as LinkIcon } from 'lucide-react'
...
export default function Explore() {
  ...
  }, [skill, minRating, showNearby, mode, jobSkill, jobStatus])
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      const openJobs = data.filter((j: Job) => j.job_giver_id !== user?.id && j.status === 'pending')
      setJobs(openJobs)
    } catch (error) {
